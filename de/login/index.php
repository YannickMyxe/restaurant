...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["email"]))){
        $email_err = "Bitte E-Mail eingeben.";
    } else{
...
<head>
    ...
    <title>Anmeldung | Multicultura</title>
    ...
    <div class="login">
        <h1>Anmeldung</h1>
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                <div class="form-item">
                    <label for="email" id="email">E-Mail Adresse</label>
                ...
                <p>
                    <button type="submit" id="btnSubmit" name="btnSubmit" class="button btnlogin">Anmeldung</button>
                    <a href="../register/" class="button btnregistreer">Ein Konto erstellen</a>
                </p>
            </form>
        </div>
    </main>
