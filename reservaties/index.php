            ...
            <div class="navbar__container">
                ...
                <ul class="navbar__menu">
                    ...
                    <li class="navbar_item">
                        <div class="drop-menu">
                            <div class="selected-drop-item ne">
                                Nederlands
                            </div>
                            <ul>
                                <li>
                                    <a class="ne" href="../reservaties/index.php">Nederlands</a>
                                </li>

                                <li>
                                    <a class="fr" href="../fr/reservaties.php">Frans</a>
                                </li>

                                <li>
                                    <a class="en" href="../en/reservations/">Engels</a>
                                </li>

                                <li>
                                    <a class="de" href="../de/buchen">Duits</a>
                                </li>
                            </ul>
                        </div>
                    </li>
